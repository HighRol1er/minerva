...
export interface BithumbRawMessage {
  ty: 'ticker';
...
export interface BybitRawMessage {
...
export interface CoinbaseRawMessage {
  type: 'ticker';
  sequence: number;
  product_id: string;
  price: string;
...
export interface KrakenRawMessage {
  channel: 'ticker';
  type: 'update';
  data: [
    {
...
// OKX 전체 메시지 타입
export type OKXRawMessage = OKXSubscribeResponse | OKXDataMessage;
